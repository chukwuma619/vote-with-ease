    ...
    return (
        <>
            ...
            <div className="h-full w-full flex flex-col gap-3 justify-start items-start">
                <h1 className="text-gray-900 text-2xl font-bold leading-none">Cast your vote</h1>
                <form action="" method="get" className="space-y-5 w-full shadow md:max-w-[60%] rounded-lg border p-4">
