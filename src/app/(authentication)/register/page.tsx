    ...
    return (
        <>
            ...
            <div className="space-y-2">
                ...
                <p className="text-gray-900 text-sm font-medium">Already have an account? <Link href={"#"} className="text-blue-600">Sign in</Link></p>
            </form>
        </>
    )
}