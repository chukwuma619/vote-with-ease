export default function ResetPassword() {
    return (
        <>
            <h1 className="text-gray-900 text-2xl font-bold">Change Password</h1>
            <form className="space-y-5">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative shadow-sm">
                        <input type="password" name="password1" id="password1" autoComplete="new-password" className="block w-full rounded-lg border-0 px-4 py-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 focus-visible:outline-none" placeholder="••••••••••" />
                    </div>
                    {/* <p className="text-gray-500 text-sm">We&apos;ll never share your details. See our Privacy Policy.</p> */}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative shadow-sm">
                        <input type="password" name="password2" id="password2" autoComplete="new-password" className="block w-full rounded-lg border-0 px-4 py-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 focus-visible:outline-none" placeholder="••••••••••" />
                    </div>
                    {/* <p className="text-gray-500 text-sm">We&apos;ll never share your details. See our Privacy Policy.</p> */}
                </div>
